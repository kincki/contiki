...
/**
 * \file
 *        Illustrates a dining philosophers problem in another aspect. One of the 
 *        philosophers favors others over himself, and renounces its turn by yielding 
 *        itself and not attempting to grab any chopsticks while there is still food on
 *        his plate. Thus, other philosophers attains chance to grab two chopsticks at
 *        a time, and finish their dinner.
 *\author
